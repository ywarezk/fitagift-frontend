# Django settings for fitagift_frontend_app project.
import os
...
SECRET_KEY = '^lorv!j_sbtx1w^85(nl6t!0v3um7znw#9(!$7laioc+7(%pxa'
...
ROOT_URLCONF = 'fitagift_frontend_app.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'fitagift_frontend_app.wsgi.application'
